...
var (
	...
	alwaysDownload        bool   // Always download bundles
...
func _main() error {
	...
	alwaysDownloadF := flag.Bool("alwaysdownload", false,
		"Always download bundles (default false)")
	...
	tuple = *tupleF
	alwaysDownload = *alwaysDownloadF
	dcrdex = *dcrdexF
	skipPGP = *skipPGPF
	quiet = *quietF
